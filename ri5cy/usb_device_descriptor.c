...
USB_RAM_ADDRESS_NONCACHEREG(uint8_t g_UsbDeviceDescriptor[]);
...
USB_RAM_ADDRESS_NONCACHEREG(uint8_t g_UsbDeviceConfigurationDescriptor[]);
...
USB_RAM_ADDRESS_NONCACHEREG(uint8_t g_UsbDeviceString0[]);
uint8_t g_UsbDeviceString0[] = {2U + 2U, USB_DESCRIPTOR_TYPE_STRING, 0x09, 0x04};

USB_RAM_ADDRESS_NONCACHEREG(uint8_t g_UsbDeviceString1[]);
...
USB_RAM_ADDRESS_NONCACHEREG(uint8_t g_UsbDeviceString2[]);
